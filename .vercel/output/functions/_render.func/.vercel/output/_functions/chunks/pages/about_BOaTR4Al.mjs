/* empty css                          */
import { e as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead } from '../astro_DHUvYCZB.mjs';
import 'kleur/colors';
import { b as $$Image, $ as $$MainLayout } from './404_DJ4Z_mV2.mjs';
...
const about = new Proxy({"src":"/_astro/about.C1FZ3Rbp.jpg","width":6000,"height":4000,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Documents/Hall_of_Justice/astro-tut/src/images/about.jpg";
							}
...
const team1 = new Proxy({"src":"/_astro/team1.CHXq7Isr.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Documents/Hall_of_Justice/astro-tut/src/images/team1.png";
							}
...
const team2 = new Proxy({"src":"/_astro/team2.Ccx9qtIf.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Documents/Hall_of_Justice/astro-tut/src/images/team2.png";
							}
...
const team3 = new Proxy({"src":"/_astro/team3.B0njnFun.png","width":750,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Documents/Hall_of_Justice/astro-tut/src/images/team3.png";
							}
...
John Doe
</h3> <p class="text-gray-70">Founder & Editor-in-Chief</p> </div> </div> <div class="bg-white shadow-lg rounded-lg overflow-hidden"> ${renderComponent($$result2, "Image", $$Image, { "src": team2, "alt": "Team Member 2", "class": "w-full h-auto" })} <div class="p-6"> <h3 class="text-xl font-semibold text-gray-900 mb-2">
Paul Newman
</h3> <p class="text-gray-70">Lead Writer</p> </div> </div> <div class="bg-white shadow-lg rounded-lg overflow-hidden"> ${renderComponent($$result2, "Image", $$Image, { "src": team3, "alt": "Team Member 3", "class": "w-full h-auto" })} <div class="p-6"> <h3 class="text-xl font-semibold text-gray-900 mb-2">
Johanna Johnson
</h3> <p class="text-gray-70">Tech Analyst</p> </div> </div> </div> </div> ` })}`;
}, "D:/Documents/Hall_of_Justice/astro-tut/src/pages/about.astro", void 0);

const $$file = "D:/Documents/Hall_of_Justice/astro-tut/src/pages/about.astro";
const $$url = "/about";
